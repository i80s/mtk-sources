		...
		BOOLEAN                                          isReg)
{
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("[%d] pAd->Cfg80211RegisterProbeReqFrame=%d[%d]\n",
		...
		BOOLEAN                                          isReg)
{
		...
		(pDevEntry != NULL))
	{
		...
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("[%d] TYPE pDevEntry->Cfg80211RegisterActionFrame=%d[%d]\n",
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("[%d] TYPE pAd->Cfg80211RegisterActionFrame=%d[%d]\n",
 ...
 */
	...
	CFG80211DBG(DBG_LVL_TRACE, ("80211> New CH = %d, New BW = %d with Ext[%d]\n",
	...
	IN VOID						*pNetDev)
{
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("==========> TYPE Reset CFG80211 Global Setting Here <==========\n"));
	pCfg80211_ctrl->cfg80211MainDev.Cfg80211RegisterActionFrame = FALSE,
	pCfg80211_ctrl->cfg80211MainDev.Cfg80211ActionCount = 0;
...
#endif
		CFG80211OS_Disconnected(pAd->net_dev);
}
