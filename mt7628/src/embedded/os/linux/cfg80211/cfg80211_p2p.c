...
VOID CFG80211_RemainOnChannelInit(RTMP_ADAPTER	 *pAd)
{
	...
	{
		CFG80211DBG(DBG_LVL_TRACE, ("CFG80211_ROC : INIT Cfg80211RocTimer\n"));
	...
	PVOID SystemSpecific2, PVOID SystemSpecific3)
{
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("CFG80211_ROC: RemainOnChannelTimeout\n"));
...
/* CFG TODO: move to cfg802_util */
		...
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("CFG80211_ROC: RemainOnChannelTimeout -- FINISH\n"));
	}
...
BOOLEAN CFG80211DRV_OpsRemainOnChannel(VOID *pAdOrg, VOID *pData, UINT32 duration)
{
	...
	{
        MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("CFG80211_NULL: APCLI PWR_SAVE ROC_START\n"));
	...
	{
    	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("CFG80211_NULL: STA PWR_SAVE ROC_START\n"));
	...
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("CFG80211_PKT: ROC CHANNEL_LOCK %d\n", pChanInfo->ChanId));
	...
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("80211> ComCH == ROC_CH \n"));
	}
...
/* CFG TODO: move to cfg802_util */
	...
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("CFG80211_ROC : CANCEL Cfg80211RocTimer\n"));
...
BOOLEAN CFG80211DRV_OpsCancelRemainOnChannel(VOID *pAdOrg, UINT32 cookie)
{
	...
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("CFG_ROC : CANCEL Cfg80211RocTimer\n"));
			...
			if (INFRA_ON(pAd))
			{
				if (!(pAd->StaCfg.wpa_supplicant_info.WpaSupplicantUP & WPA_SUPPLICANT_ENABLE_WPS)) //WPS not under goining!
				{
					...
					p2p_wdev = &pApCliEntry->wdev;
    					...
    					MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("CFG Debug: Infra AuthMode =%d, wdev->WepStatus=%d\n",wdev->AuthMode,wdev->WepStatus));
